        ...
        <div>
            <div className="flex flex-col items-center justify-center sm:mx-2 lg:mx-10">
                <div className="container mx-auto">
                    ...
                    <img className="mx-auto rounded-3xl max-w-sm lg:max-w-4xl" src={logo.src}></img>
                    ...
                    <img className="max-w-sm lg:max-w-4xl mx-auto mt-10 rounded-3xl" src={solution.src}></img>

                    <h2 className="text-accent text-lg font-bold mb-5 sm:mx-2 lg:mx-20 mt-10">IMPLEMENTATION OVERVIEW</h2>
                    <img className="max-w-sm lg:max-w-4xl mx-auto my-10 rounded-3xl border-accent border-[1px]" src={overview.src}></img>
                    ...
                    <img className="max-w-sm lg:max-w-4xl mx-auto my-10 rounded-3xl" src={algo.src}></img>
                    ...
                    <img className="max-w-sm lg:max-w-4xl mx-auto my-10 rounded-3xl" src={scoring.src}></img>
